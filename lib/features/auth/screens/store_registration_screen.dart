...
import 'package:moonjoin/features/auth/widgets/business/base_card_widget.dart';
import 'package:moonjoin/features/auth/widgets/business/web_business_plan_widget.dart';
import 'package:moonjoin/features/auth/widgets/module_view_widget.dart';
import 'package:moonjoin/features/auth/widgets/web_registration_stepper_widget.dart';
import 'package:moonjoin/features/business/widgets/package_card_widget.dart';
...
import 'package:moonjoin/common/models/translation.dart';
...
import 'package:moonjoin/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:moonjoin/features/auth/widgets/pass_view_widget.dart';
import 'package:moonjoin/features/auth/widgets/select_location_view_widget.dart';
                  ...
                  Visibility(
                    ...
                    child: Form(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        sectionCard(
                          title: 'vendor_logo_and_cover_photo'.tr,
                          child: Row(children: [
                            Expanded(flex: 4,
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Expanded(flex: 6,
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Row(children: [
                                  ...
                                  Text('*'.tr, style: robotoRegular.copyWith(color: Theme.of(context).colorScheme.error)),
                                  Text(' (${'2:1'})', style: robotoRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                                ]),
                                const SizedBox(height: Dimensions.paddingSizeDefault),
