    ...
    return storeRegController.zoneList != null ? storeRegController.zoneList!.isNotEmpty ? Stack(clipBehavior: Clip.none, children: [
      ...
      Container(
        ...
        child: CustomDropdown<int>(
          key: ValueKey('zone_dropdown_${storeRegController.selectedZoneIndex ?? -1}'),
          ...
          child: Padding(
            ...
            child: Text(storeRegController.selectedZoneIndex == null || (storeRegController.selectedZoneIndex == -1) ? 'select_zone'.tr : storeRegController.zoneList![storeRegController.selectedZoneIndex!].name.toString(),),
          ),
        ),
      ),
