...
import 'package:moonjoin/features/auth/widgets/pickup_zone_widget.dart';
import 'package:moonjoin/features/auth/widgets/zone_selection_widget.dart';
...
import 'package:moonjoin/features/location/widgets/permission_dialog_widget.dart';
import 'package:moonjoin/features/splash/controllers/splash_controller.dart';
import 'package:moonjoin/features/auth/controllers/store_registration_controller.dart';
import 'package:moonjoin/features/location/widgets/location_search_dialog_widget.dart';
...
class SelectLocationViewWidget extends StatefulWidget {
  ...
  final bool inDialog;
  const SelectLocationViewWidget({super.key, required this.fromView, this.mapController, this.mapView = false, this.zoneModuleView = false, this.addressController, this.addressFocus, this.inDialog = false});
              ...
              onCameraIdle: () {
                ...
                if (foundZoneIndex != null) {
                  ...
                  if (storeRegController.selectedZoneIndex != foundZoneIndex) {
                    ...
                    storeRegController.setZoneIndex(foundZoneIndex, canUpdate: false);
