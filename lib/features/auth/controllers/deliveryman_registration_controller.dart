...
import 'package:moonjoin/features/auth/domain/models/delivery_man_vehicles_model.dart';
...
class DeliverymanRegistrationController extends GetxController implements GetxService {
  ...
  DMRegistrationSteps _dmStatus = DMRegistrationSteps.stepOne;
  DMRegistrationSteps get dmStatus => _dmStatus;
  ...
  void dmStatusChange(DMRegistrationSteps value, {bool isUpdate = true}){
    _dmStatus = value;
    if(isUpdate) {
      update();
    }
