    ...
    return (isOfflinePaymentActive && offlineMethodList != null && offlineMethodList!.isNotEmpty) ? InkWell(
      ...
      child: Container(
        ...
        child: Column(children: [
          ...
          isSelected ? GetBuilder<ParcelController>(
            builder: (parcelController) {
              return GridView.builder(
                ...
                itemBuilder: (context, index) {
                  bool isSelected = !forParcel ? Get.find<PaymentController>().selectedOfflineBankIndex == index : parcelController.selectedOfflineBankIndex == index;
                  return Container(
                    decoration: BoxDecoration(
                    ...
                    child: CustomInkWell(
                      onTap: () {
                        if(!forParcel) {
                          ...
                          Get.find<PaymentController>().selectOfflineBank(index);
                        } else {
