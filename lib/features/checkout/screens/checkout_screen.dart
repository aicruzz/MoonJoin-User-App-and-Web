...
import 'package:moonjoin/common/widgets/moonjoin/moonjoin_commerce_action_bar.dart';
...
import 'package:moonjoin/features/checkout/widgets/checkout_screen_shimmer_view.dart';
import 'package:moonjoin/features/checkout/widgets/payment_method_bottom_sheet.dart';
import 'package:get/get.dart';
import 'package:moonjoin/features/checkout/widgets/bottom_section.dart';
import 'package:moonjoin/features/checkout/widgets/top_section.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget _orderPlaceButton(CheckoutController checkoutController, bool todayClosed, bool tomorrowClosed,
    ...
    final Widget placeOrderButton = CustomButton(
          ...
          if(isGuestLogIn && checkoutController.orderType == 'take_away' && guestContactPersonNumberController.text.isNotEmpty) {
          ...
          } else if(isGuestLogIn && checkoutController.orderType == 'take_away' && !isGuestValidNumber) {
