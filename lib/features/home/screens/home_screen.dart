...
import 'package:moonjoin/features/home/widgets/cashback_logo_widget.dart';
import 'package:moonjoin/features/home/widgets/cashback_dialog_widget.dart';
import 'package:moonjoin/features/home/widgets/refer_bottom_sheet_widget.dart';
...
import 'package:moonjoin/features/rental_module/home/screens/taxi_home_screen.dart';
...
import 'package:moonjoin/common/widgets/cart_widget.dart';
import 'package:moonjoin/features/rental_module/common/widgets/taxi_cart_widget.dart';
...
import 'package:moonjoin/features/home/screens/web_new_home_screen.dart';
                ...
                slivers: [
                  ...
                  isTaxi ? const SliverToBoxAdapter() : SliverAppBar(
                    ...
                    title: Center(child: Container(
                      width: Dimensions.webMaxWidth, height: Get.find<LocalizationController>().isLtr ? 65 : 70, color: Theme.of(context).colorScheme.surface,
                      child: Row(children: [
                        ...
                        Stack(
                          children: [
                            ClipOval(
                              child: AuthHelper.isLoggedIn() ? CustomImage(
                                image: Get.find<ProfileController>().userInfoModel?.imageFullUrl ?? '',
                                height: 45, width: 45, fit: BoxFit.cover,
                              ) : Image.asset(Images.guestIcon, height: 45, width: 45, fit: BoxFit.cover),
                            ),
                            Positioned(
                              bottom: 0, right: 0,
                              child: Container(
                                ...
                                child: Icon(Icons.check_circle, size: 14, color: Theme.of(context).primaryColor),
                              ),
                            ),
                          ],
                        ),
                        ...
                        Expanded(child: InkWell(
                          ...
                          child: Padding(
                            ...
                            child: GetBuilder<LocationController>(builder: (locationController) {
                              ...
                              String greetingTxt = hour < 12 ? 'Good Morning' : hour < 17 ? 'Good Afternoon' : 'Good Evening';
                              String name = AuthHelper.isLoggedIn() ? (Get.find<ProfileController>().userInfoModel?.fName ?? '') : 'Guest';
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    Flexible(
                                      child: Text(
                                        'Delivering to: ${AddressHelper.getUserAddressFromSharedPref()?.address ?? 'your_location'.tr}',
                        ...
                        InkWell(
                          child: GetBuilder<NotificationController>(builder: (notificationController) {
                            return Stack(children: [
                              Icon(CupertinoIcons.bell, size: 28, color: Theme.of(context).textTheme.bodyLarge!.color),
                              Positioned(
                                top: 0, right: 2, 
                                child: Container(
                  ...
                  !showMobileModule && !isTaxi ? SliverPersistentHeader(
                    pinned: true,
                    delegate: SliverDelegate(height: 70, callback: (val){}, child: Center(child: Container(
                      ...
                      child: isTaxi? Container(color: Theme.of(context).primaryColor): InkWell(
                        ...
                        child: Container(
                          padding: const EdgeInsets.only(left: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeExtraSmall, top: Dimensions.paddingSizeExtraSmall, bottom: Dimensions.paddingSizeExtraSmall),
                          decoration: BoxDecoration(
                            color: Theme.of(context).cardColor,
                            borderRadius: BorderRadius.circular(30),
                            boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.05), blurRadius: 10, spreadRadius: 0, offset: Offset(0, 4))],
                          ),
                          child: Row(children: [
                            Icon(
                              CupertinoIcons.search, size: 22,
