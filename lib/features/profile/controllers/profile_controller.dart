...
class ProfileController extends GetxController implements GetxService {
  ...
  Future<void> getUserInfo() async {
    ...
    if (userInfoModel != null) {
      ...
      if (_userInfoModel!.virtualAccountNumber != null && _userInfoModel!.virtualAccountNumber!.isNotEmpty) {
        _virtualAccountData = {
          'account_number': _userInfoModel!.virtualAccountNumber,
          'account_name': _userInfoModel!.virtualAccountName,
          'bank_name': _userInfoModel!.bankName ?? '9PSB',
        };
      } else if (Get.find<SplashController>().configModel!.virtualAccountNumber != null && Get.find<SplashController>().configModel!.virtualAccountNumber!.isNotEmpty) {
        _virtualAccountData = {
          'account_number': Get.find<SplashController>().configModel!.virtualAccountNumber,
          'account_name': Get.find<SplashController>().configModel!.virtualAccountName,
          'bank_name': Get.find<SplashController>().configModel!.bankName ?? '9PSB',
        };
      } else {
        _virtualAccountData = null;
      }
    }
    update();
  }
  ...
  /// Virtual Account
  bool _isGeneratingAccount = false;
  bool get isGeneratingAccount => _isGeneratingAccount;
